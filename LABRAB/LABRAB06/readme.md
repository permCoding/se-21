...
## ЛАБРАБ-05 - __,__.04.21  

*deadline __.05.21 24:00*  

Тема MySQL  
Часть 2.  
Обработка данных связанных таблиц средствами **SQL** и **mysql2**.  
...
В папке csv заберите все csv-файлы и из них сделайте таблицы в базе данных.  
...
> Каждая программа посылает SQL-запрос к БД и получает в ответ данные, их выводит на экран в табличном виде.  
> Предварительно сами SQL-запросы вы можете отрабатывать непосредственно в **phpMyAdmin**.  

task_01.  
Напишите программу, которая будет реализовывать следущую задачу:  
Вывести на экран в табличном виде первые 10 абитуриентов в порядке убывания рейтинга.  
Первый столбец - рейтинг, второй - Фамилия Имя, третий - город.  
Данные по столбцам должны быть сформированы запросом SQL (сортировка и объединение Фамилии и Имени не средствами node.js).  
...
создавать таблицу **data_set** в базе данных с названиями полей и типами их данных в соответствии со структурой **data_set.csv**.  
