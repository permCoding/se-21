...
Программные решения выполнить с использованием библиотеки **lodash**. Данные для задач брать из таблиц (в соответсвующих csv-файлах [папка csv](https://github.com/permCoding/se-21/tree/main/theme-05-lodash/part2/csv)) - students, groups, curators, hobby, merge.  
